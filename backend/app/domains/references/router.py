...
async def create_renewal_period(
    data: schemas.RenewalPeriodCreate,
    db: AsyncSession = Depends(get_db),
    user: User = require_manager,
):
...
async def update_renewal_period(
    period_id: int,
    data: schemas.RenewalPeriodUpdate,
    db: AsyncSession = Depends(get_db),
    user: User = require_manager,
):
...
async def delete_renewal_period(
    period_id: int,
    db: AsyncSession = Depends(get_db),
    user: User = require_manager,
):
...
async def create_asset_type_field(
    type_id: int,
    data: schemas.AssetTypeFieldCreate,
    db: AsyncSession = Depends(get_db),
    user: User = require_manager,
):
...
async def update_asset_type_field(
    field_id: int,
    data: schemas.AssetTypeFieldUpdate,
    db: AsyncSession = Depends(get_db),
    user: User = require_manager,
):
...
async def delete_asset_type_field(
    field_id: int,
    db: AsyncSession = Depends(get_db),
    user: User = require_manager,
):
